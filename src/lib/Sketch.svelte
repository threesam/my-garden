...
<div
	bind:this={container}
	class="w-full relative {isLoaded ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500"
>
		...
		<div class="absolute inset-0 flex items-center justify-center pointer-events-none">
			<div class="text-center text-black z-10 px-6 max-w-4xl mx-auto">
				{#if sketchData.content.overlayText}
					<h1 class="text-5xl md:text-7xl font-bold mb-6 drop-shadow-lg font-loading">
